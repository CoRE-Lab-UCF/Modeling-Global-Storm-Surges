...
cd 'F:\OneDrive - Knights - University of Central Florida\Daten\Tide_data\TG_mat_global_unique'
mat_file = dir('*.mat');

%% Run loop for Skew surge analysis 
cd 'F:\OneDrive - Knights - University of Central Florida\Daten\Tide_data\Skew_surge_max_v2'
fid = fopen('Ausnahmen.txt', 'a'); % Create a txt file to write gauges that have problems

for ii = 108:length(mat_file)%length(mat_file)
    ii
    ...
    folder = 'F:\OneDrive - Knights - University of Central Florida\Daten\Tide_data\Skew_surge_max_v2'

...
tg_lst = dir(base_dir);
tg_lst(1:2) = []; 
cd 'F:\OneDrive - Knights - University of Central Florida\Daten\MLR\Model_2\Extracted2'
fid = fopen('Skipped TGs.txt', 'wt');

tic
parfor ii = 1:length(tg_lst)
    ii
 ...
 %% Time-shift predictors
   ...
   %% Save	   
    ...
    save('surge_dmax.mat', 'surge_sub');% saving surge separately

...
for jj = 385:length(lst1)
    ...
    %compute zscores for model 2.2 (all predictors squared)
    zu0 = zscore(u0_rsh.*u0_rsh);
    zu6 = zscore(u6_rsh.*u6_rsh);
    zu12 = zscore(u12_rsh.*u12_rsh);
    zu18 = zscore(u18_rsh.*u18_rsh);
    zu24 = zscore(u24_rsh.*u24_rsh);
    zu30 = zscore(u30_rsh.*u30_rsh);
    
    
    zv0 = zscore(v0_rsh.*v0_rsh);
    zv6 = zscore(v6_rsh.*v6_rsh);
    zv12 = zscore(v12_rsh.*v12_rsh);
    zv18 = zscore(v18_rsh.*v18_rsh);
    zv24 = zscore(v24_rsh.*v24_rsh);
    zv30 = zscore(v30_rsh.*v30_rsh);
   ...
   %slp
    ...
    folder = 'F:\OneDrive - Knights - University of Central Florida\Daten\MLR\Model_2\M2.2\mdl2p2_PCA_4Xdaily10X10_17yrs'

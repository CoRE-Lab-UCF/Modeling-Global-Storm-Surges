...
b_pat =  'D:\OneDrive - Knights - University of Central Florida\Daten\MLR\TG_pct_pcd_4X4'
...
for t = 1:length(list_tg)%pp = 1:length(pool)%t = 1:3%length(list_tg)
    ...
    if min(b) < max(a)
        cd 'D:\OneDrive - Knights - University of Central Florida\Daten\MLR\PCA_Stepwise_confg_13_4X4'
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    % Saving .mat files
    folder = 'D:\OneDrive - Knights - University of Central Florida\Daten\MLR\PCA_Stepwise_confg_13_4X4'

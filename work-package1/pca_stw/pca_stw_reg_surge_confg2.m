...
cd 'F:\OneDrive - Knights - University of Central Florida\Daten\MLR\PCA_Stepwise_config_2'
...
for pp = 1:length(pool)%t = 1:3%length(list_tg)
    t = pool(pp)
    cd(fullfile(basepath, list_tg(t).name))%cd(fullfile(basepath, list_tg(t).name))
    disp(list_tg(t).name)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    % Saving .mat files
    folder = 'F:\OneDrive - Knights - University of Central Florida\Daten\MLR\PCA_Stepwise_config_2'

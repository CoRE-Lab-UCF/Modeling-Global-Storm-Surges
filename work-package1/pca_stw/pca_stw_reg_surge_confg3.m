...
for pp = 1:length(pool)%t = 1:3%length(list_tg)
    ...
    all_nan = unique([sg_nan]); %combine nans
    ...
    % Compute zscores 
    z_u = zscore(u_rsh2.*u_rsh2.*u_rsh2); z_v = zscore(v_rsh2.*v_rsh2.*v_rsh2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    % Saving .mat files
    folder = 'F:\OneDrive - Knights - University of Central Florida\Daten\MLR\PCA_Stepwise_confg_3'

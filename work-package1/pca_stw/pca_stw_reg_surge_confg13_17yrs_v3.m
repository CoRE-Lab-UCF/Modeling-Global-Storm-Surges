...
for t = 2:2%length(list_tg)%pp = 1:length(pool)%t = 1:3%length(list_tg)
    ...
    load(pcd);  
    clearvars -except pp pool b_pat list_tg t Twind umax_daily vmax_daily sk_daily surge_daily lat_t lon_t
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    % Saving .mat files
    folder = 'F:\OneDrive - Knights - University of Central Florida\Daten\MLR\PCA_Stepwise_confg_13_10X10_17yrs'

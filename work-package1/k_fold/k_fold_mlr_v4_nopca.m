b_p = 'F:\OneDrive - Knights - University of Central Florida\Daten\MLR\Model_2\MLR_NOPCA_Kfold_4daily_10X10_17yrs'
cd 'F:\OneDrive - Knights - University of Central Florida\Daten\MLR\Model_2\NOPCA_4Xdaily10X10_17yrs'
lst = dir('*.mat');
...
for i_i = 1:length(lst)
    ...
    f2 = sprintf('%s_4d_mlr.mat', char(f1(1)));
    save(f2);

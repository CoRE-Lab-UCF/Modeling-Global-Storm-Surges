...
using https://learnui.design/tools/data-color-picker.html
for generating colors

modified on nov 02, 10:38:00 2021
...
def plotIt(recon):
    ...
    dat['yrGainedSign'].replace('nan', 'Discarded', inplace = True)

    datDiscarded = dat[dat['yrGainedSign'] == "Discarded"]
    dat = dat[dat['yrGainedSign'] != "Discarded"]
    dat.sort_values("numYearsGained", ascending=False, inplace = True)
    ...
    sns.scatterplot(x = x, y = y, s = 100, color = 'red', hue = 'yrGainedSign',  

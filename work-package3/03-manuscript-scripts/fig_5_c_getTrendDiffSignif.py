...
Modified on Wed Feb 02 08:32:00 2022
...
from fig_5_b_interactionRegression import getDummy, simpleReg
...
dirHome = "G:\\report\\year-3\\07-Fall-2020\\#3Paper\\data\\"\
        "trend-analysis\\data\\allThreeTrends\\99_post1930_30yrs_75perc"
dirOut = "G:\\report\\year-3\\07-Fall-2020\\#3Paper\\data\\"\
        "trend-analysis\\data\\allThreeTrends\\99TrendDiffSign_post1930"

os.chdir(dirHome)

#################################################################################
# create empty dataframe - for trend computation 
dfTrend = pd.DataFrame(columns = ['tg', 'lon', 'lat', 'obsTwcrPval', 
        'obsEra20cPval'])
#################################################################################
...
# save as csv
os.chdir(dirOut)
dfTrend.to_csv("99thPercObsTwcrEra20cTrendDiffSign_30yr_75perc_post1930.csv")

...
def plotSTD_CPT(tg):
    ...
    ax[0,0].legend()
    ax[0,0].set_ylabel("Standard Deviation in Pa", fontsize=16)
    ...
    ax[0,1].legend()
    ax[0,1].set_ylabel("Standard Deviation in m/s", fontsize=16)
    ...
    ax[1,0].legend()
    ax[1,0].set_ylabel("Standard Deviation in m/s", fontsize=16)
    ...
    ax[1,1].legend()
    ax[1,1].set_ylabel("Standard Deviation in m", fontsize=16)
    ...
    # save image
    os.chdir(dirOut)
    plt.savefig(tg.split('.csv')[0]+".svg", dpi=400)
...
tg = "l._cornwallis_i._705a_canada.csv"
plotSTD_CPT(tg)
...
get annual percentiles of G-20CR G-E20C and Obs  
...
dir_home = "G:\\report\\year-3\\07-Fall-2020\\#3Paper\\data"\
            "\\trend-analysis\\data\\chosen_tgs_sensitivity\\rawData\\additional_tgs"
...
def getPercentile(x):
    ...
    for tg in tgList:
        ...
        dat = pd.read_csv(tg)[['date', 'lon', 'lat', 'surge', 'twcr_surge', 'era20c_surge']]
        ...
        df = pd.DataFrame(columns = ['year', 'obs', 'twcr', 'era20c', 'lon', 'lat'])

"""
Created on Fri jul 01 12:15:00 2021
...
def plotSTD_CPT(tgs):
    ...
    for tg in tgs:
        ...
        # ax[0,1].legend()
        ax[0,1].set_ylabel("Wnd_U annual variability in m/s")
        ...
        # ax[1,0].legend()
        ax[1,0].set_ylabel("Wnd_V annual variability in m/s")
        ...
        ax[1,1].legend()
        ax[1,1].set_ylabel("Surge annual variability in m")

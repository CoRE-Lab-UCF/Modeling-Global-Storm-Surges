"""  
this script plots predictor and Recon STDs and the four BCPs with their average - twcr
"""
...
dirOut = "G:\\report\\year-3\\07-Fall-2020\\#3Paper\\data\\changePointTimeSeries\\"\
    "mamun-cpt-approach\\twcr\\0001-predCPT\\cptPlots_manuscript"
...
def plotSTD_CPT(tg):
    ...
    ax[2,1].set_ylabel("annual variability in m", fontsize=16)
    ...
    # # main title
    # plt.suptitle(tg.split('.csv')[0] + " - twcr", y = 0.9999999, fontweight="bold")
    plt.show()  
